...
style.textContent = `
  body { background:#0f1318; color:#e6e6e6; }
  ...
  .acc-settings-root .list-group-item.active { background: #0d6efd; color: #fff; border-color: #0d6efd; }
  ...
  /* 讓畫面與首頁同寬置中 */
  .acc-container { max-width: 1200px; margin: 0 auto; padding: 24px 12px; }
  @media (min-width: 1200px) { .acc-container { padding-top: 32px; } }
`;
...
function renderShell(root){
  ...
  root.innerHTML = `
    <div class="acc-container container-xl">
      <div class="mb-3">
